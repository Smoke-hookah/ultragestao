"""Staging e manifestos da validacao de cobertura do lote."""
...
DEFAULT_COVERAGE_TTL_SECONDS = 60 * 60


@dataclass
class CoverageStagingStore:
    base_dir: Path
    ttl_seconds: int = DEFAULT_COVERAGE_TTL_SECONDS
...
def criar_store_cobertura_padrao() -> CoverageStagingStore:
    return CoverageStagingStore(OUTPUT_DIR / "cobertura_lote")
